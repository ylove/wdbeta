...
export const useWindogePrice = (): Price | undefined => {
  const windoge95 = useToken('0x956ca51cc658835ca589eba83fe0ae12e5b7e5e5')
  const bnbBusdPrice = useBUSDPrice(windoge95)
  return bnbBusdPrice
}

export const useDogePrice = (): Price | undefined => {
  const dogeCoin = useToken('0xba2ae424d960c26247dd6c32edc70b295c744c43')
  const bnbBusdPrice = useBUSDPrice(dogeCoin)
  return bnbBusdPrice
}

...
import ColoredWordHeading from 'views/RewardsDashboard/components/ColoredWordHeading'
import { LandingBodyWrapper } from 'views/PancakeSquad/styles'
import { SlideSvgDark, SlideSvgLight } from 'views/RewardsDashboard/components/SlideSvg'

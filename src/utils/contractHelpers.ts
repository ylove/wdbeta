...
import rewardsContractAbi from 'config/abi/WindogeRewardABI.json'
...
export const getWindogeRewardContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(rewardsContractAbi, '0x71ddD5196cdcf619a9b6924E52D639274062cCc0', signer)
}
